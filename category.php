         ...
         ?>
                            ...
                            <div class="row">
                                <div class="col-md-9 col-md-push-3">
                                    ...
                                    $menudataQuery="SELECT * FROM catagory WHERE cat_name='$menuShow'";
                                    ...
                                    $postData="SELECT * FROM books WHERE book_status=1 AND
                                    category_id='$cat_id' ORDER BY book_id DESC ";
                                    ...
                                    if($count!=0){
                                        ...
                                        echo '<div class="alert alert-info">No Books Uploaded in this section yet.</div>';
                                    }
                                }
                                     ?>
