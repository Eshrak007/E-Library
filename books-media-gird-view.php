                            ...
                            <div class="row">
                                <div class="col-md-9 col-md-push-3">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 col-sm-4">
                                                <div class="filter-result">
                                                   ...
                                                   $book_data="SELECT * FROM books WHERE book_status=1 ORDER BY book_id DESC ";
                                                   $passBook_data=$postQuery=mysqli_query($con,$book_data);
                                                   $countbook=mysqli_num_rows($postQuery);
                                                   echo "Total Books: ".$countbook
                                                    ?> 
                                    ...
                                    <div class="books-gird">
                                        <ul>
                                    <?php 
                                    $postData="SELECT * FROM books WHERE book_status=1 ORDER BY book_id DESC ";
                                                ...
                                                <div class="single-book-box">
                                                    <div class="post-detail">
                                                        ...
                                                        <?php
                                                           ...
                                                           ?>
                                                            <footer class="entry-footer">
                                                            <a class="btn btn-primary" href="signin.php">Read More</a>
                                                        </footer>
                                                           <?php
                                                        }
